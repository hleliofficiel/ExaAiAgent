...
from exaaiagnt.interface.cli import run_cli
from exaaiagnt.interface.tui import run_tui
from exaaiagnt.interface.utils import (
...
def validate_environment() -> None:  # noqa: PLR0912, PLR0915
    ...
    if not os.getenv("EXAAI_LLM"):
        missing_required_vars.append("EXAAI_LLM")
    ...
    if missing_required_vars:
        ...
        for var in missing_required_vars:
            if var == "EXAAI_LLM":
                ...
                error_text.append("EXAAI_LLM", style="bold cyan")
                error_text.append(
        ...
        error_text.append("\nExample setup:\n", style="white")
        error_text.append("export EXAAI_LLM='openai/gpt-5'\n", style="dim white")
...
async def warm_up_llm() -> None:
    ...
    try:
        model_name = os.getenv("EXAAI_LLM", "openai/gpt-5")
...
def pull_docker_image() -> None:
    ...
    if image_exists(client, EXAAI_IMAGE):
        return

    console.print()
    console.print(f"[bold cyan]🐳 Pulling Docker image:[/] {EXAAI_IMAGE}")
    ...
    with console.status("[bold cyan]Downloading image layers...", spinner="dots") as status:
        try:
            ...
            for line in client.api.pull(EXAAI_IMAGE, stream=True, decode=True):
            ...
            error_text.append("\n\n", style="white")
            error_text.append(f"Could not download: {EXAAI_IMAGE}\n", style="white")
