...
if TYPE_CHECKING:
    from exaaiagnt.telemetry.tracer import Tracer
...
from exaaiagnt.llm import LLM, LLMConfig, LLMRequestFailedError
...
class BaseAgent(metaclass=AgentMeta):
    ...
    async def _wait_for_input(self) -> None:
        ...
        if self.state.has_waiting_timeout():
            ...
            try:
                from exaaiagnt.tools.agents_graph.agents_graph_actions import _agent_graph
    ...
    async def _initialize_sandbox_and_state(self, task: str) -> None:
        ...
        if not sandbox_mode and self.state.sandbox_id is None:
            from exaaiagnt.runtime import get_runtime
