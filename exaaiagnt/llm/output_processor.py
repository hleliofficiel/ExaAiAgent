...
class OutputProcessor:
    ...
    def _process_directories(self, output: str) -> str:
        ...
        result = "[Directory Discovery Summary]\n"
    ...
    def _process_vulnerabilities(self, output: str) -> str:
        ...
        result = "[Vulnerability Scan Summary]\n"
    ...
    def _get_cache_key(self, tool_name: str, output: str) -> str:
        ...
        return hashlib.md5(combined.encode()).hexdigest()[:16]  # nosec: B324
...
_processor: OutputProcessor | None = None
